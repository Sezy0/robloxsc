...
MovementSection:Toggle("NoClip", false, function(state)
    if state then
    ...
    NextUI:Notification("NoClip", state and "Enabled" or "Disabled", 1.5)
end)

MovementSection:Label("")
MovementSection:Label("Tembus tembok/objek")
